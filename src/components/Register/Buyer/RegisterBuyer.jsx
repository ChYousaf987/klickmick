...
//                         <div className="flex sm:flex-none items-center justify-center w-10 h-10 bg-gradient-to-b from-[#FF6413] to-[#FF8342] text-white rounded-full shadow-md mt-6 sm:mt-6 sm:flex sm:w-10 sm:h-10 sm:visible invisible ">
...
//                         </div>
//                         <div className="flex flex-col w-full">
//                             <label className="block text-sm font-medium text-[#3c3c3c] font-poppins mb-1 max-sm:text-left text-center sm:text-left">
//                                 Nick Name
//                             </label>
//                             <div className="flex items-center bg-white rounded-full px-4 py-2 shadow-sm w-full max-sm:mx-0">
//                                 <input
//                                     type="text"
//                                     placeholder="Search here"
//                                     className="flex-1 bg-transparent outline-none text-[#a4a4a4] font-opensans font-semibold"
...
//                             <div className="flex flex-col w-full">
//                                 <label className="block text-sm font-medium text-[#3c3c3c] mb-1 max-sm:text-left text-center sm:text-left">
//                                     First Name
//                                 </label>
//                                 <div className="flex items-center bg-white rounded-full px-4 py-2 shadow-sm w-full max-sm:mx-0">
//                                     <input
