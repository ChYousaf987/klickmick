    ...
    <>
      ...
      <section className="bg-[#FFEFE6] py-10 flex justify-center opacity-90">
        <div className="relative w-[92%] sm:w-[90%] md:w-[85%] rounded-3xl shadow-md overflow-hidden flex flex-col lg:flex-row items-center justify-between">
          ...
          <div className="relative right-[-10px] lg:w-1/2 mt-10 lg:mt-0 justify-center items-center z-10 hidden sm:flex">
            {/* IMAGE */}
            <img
              src="/home.png"
              alt="Product Display"
            ...
            <div className="absolute bottom-32 left-4 bg-white shadow-lg px-2 sm:px-3 py-1 rounded-full flex items-center gap-1 sm:gap-2 text-[10px] sm:text-sm font-medium font-opensans">
