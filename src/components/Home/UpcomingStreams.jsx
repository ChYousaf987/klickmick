...
const UpcomingStreams = () => {
  ...
  return (
    <section className="bg-[#FFF1EB] px-16 ">
      <div className="max-w-7xl mx-auto">
        {/* 🔸 Header */}
        <div className="flex justify-between items-center mb-6 pt-12">
          <div>
            <h3 className="text-2xl font-bold text-gray-800 flex items-center gap-2 max-md:text-lg">
          ...
          <button className="border border-orange-500 text-orange-500 px-6 py-2 rounded-full text-sm font-medium hover:bg-orange-50 transition max-md:text-sm max-md:px-2 max-md:py-0">
            View All
          </button>
        </div>
        ...
        <div className="py-10 group">
          <Swiper
            ...
            allowTouchMove={false} // optional (disables manual dragging)
          >
                ...
                <div className="bg-white rounded-2xl shadow-md overflow-hidden hover:shadow-lg transition-all duration-300 ">
                  ...
                  <div className="p-4">
                    ...
                    <button
                      ...
                      disabled={stream.reminderSet}
                    >
                      {stream.reminderSet ? "Reminder Set" : "Set Reminder"}
                    </button>
                  </div>
                </div>
              </SwiperSlide>
