...
const Recommendation = () => {
    ...
    return (
        <div className="bg-[#FFEFE6] py-10 px-4 md:px-10 rounded-lg">
            {/* Header Section */}
            <div className="flex justify-between items-center w-full sm:w-[95%] md:w-[90%] mx-auto mb-8">
                <h2 className="text-[22px] sm:text-[24px] font-semibold text-gray-800">
                    Recommended
                </h2>
                <button className="text-sm border border-orange-400 text-orange-500 px-4 py-1.5 rounded-full hover:bg-orange-100 transition-all">
                    View All
                </button>
            </div>
